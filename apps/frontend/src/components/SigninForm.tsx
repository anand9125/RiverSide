...
const LoginForm: React.FC = () => {
  ...
  const { userSignin,isLoading } = uesUserStore();
  ...
  return (
    <div className="glass-card w-full max-w-md p-8 rounded-xl animate-fade-in">
      ...
      <h3 className="text-xl font-medium text-center mb-6 text-white">Sign in to your account</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-center text-sm text-gray-300">
          ...
          <a href="/signup" className="text-podcast-accent-blue hover:underline">
            Sign up
          </a>
        </div>
      </form>
